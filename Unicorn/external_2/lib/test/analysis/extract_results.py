...
import sys
import numpy as np
from external_2.lib.test.utils.load_text import load_text
import torch
import pickle
...
from external_2.lib.test.evaluation.environment import env_settings
...
def extract_results(trackers, dataset, report_name, skip_missing_seq=False, plot_bin_gap=0.05,
    ...
    for seq_id, seq in enumerate(tqdm(dataset)):
        ...
        for trk_id, trk in enumerate(trackers):
            # Load results
            # print("trk.results_dir : ",trk.results_dir)
            # print("trk.dataset_name : ",trk.dataset_name)     
            # base_results_path = '{}/{}/{}'.format(trk.results_dir,trk.dataset_name, seq.name)
