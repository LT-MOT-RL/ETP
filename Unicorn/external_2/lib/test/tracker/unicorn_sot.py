...
from external_2.lib.test.tracker.basetracker import BaseTracker
...
class UnicornSOTTrack(BaseTracker):
    ...
    def initialize(self, image, info: dict):
        ...
        # print('info["init_bbox"] : ',info["init_bbox"])
        with torch.no_grad():
    ...
    def track(self, image, info: dict = None, bboxes=None, scores=None, gt_box=None):
        ...
        if output is not None:
            ...
            # print({"target_bbox": self.state,"conf_score": scores[0]})

            return {"target_bbox": self.state,"conf_score": scores[0]}
        else:

            return {"target_bbox": self.state,"conf_score": 0.0}
