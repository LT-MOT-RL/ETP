...
def local_env_settings():
    ...
    settings.lasot_path = '/Data/belong_to_user5/tracking/datasets/LaSOT'
    ...
    settings.result_plot_path = '/Data/belong_to_user5/tracking/OTETrack/test/result_plots/'
    settings.results_path = '/Data/belong_to_user5/tracking/results/LaSOT'    # Where to store tracking results
